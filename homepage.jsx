            ...
            <div className="content">
              ...
              <div className="cards-section">
                <div className="card">
                  ...
                  <div className="card-content">
                    <Link to="/paneertikka"><h2 className='recipename'>Paneer Tikka</h2></Link>
                ...
                <div className="card">
                  ...
                  <div className="card-content">  
                    <Link to="/hydrabadibiriyani"><h2 className='recipename'>Hyderabadi Biriyani</h2></Link>
                ...
                <div className="card">
                  ...
                  <div className="card-content">
                    <Link to="/thandai"><h2 className='recipename'>Thandai</h2></Link>
